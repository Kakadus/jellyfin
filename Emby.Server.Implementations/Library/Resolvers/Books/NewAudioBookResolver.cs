...
{
    /// <summary>
    /// Class NewAudioBookResolver.
    /// </summary>
    public class NewAudioBookResolver : ItemResolver<NewAudioBook>
    {
        private readonly ILogger<NewAudioBookResolver> _logger;
        private readonly NamingOptions _namingOptions;

        /// <summary>
        /// Initializes a new instance of the <see cref="NewAudioBookResolver"/> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        /// <param name="namingOptions">The naming options.</param>
        public NewAudioBookResolver(ILogger<NewAudioBookResolver> logger, NamingOptions namingOptions)
        {
            _logger = logger;
        ...
        protected override NewAudioBook Resolve(ItemResolveArgs args)
        {
            var collectionType = args.GetCollectionType();
            var isMusicMediaFolder = string.Equals(collectionType, CollectionType.Books, StringComparison.OrdinalIgnoreCase);
            ...
            if (args.HasParent<NewAudioBook>())
            {
                return null;
            }
            ...
            return IsMusicAlbum(args) ? new NewAudioBook() : null;
        }
